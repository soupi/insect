...
(function(exports) {
  ...
  var genericRep = new Data_Generic.Generic(function (v) {
      ...
      throw new Error("Failed pattern match at Insect.Language line 76, column 1 - line 76, column 41: " + [ v.constructor.name ]);
  });
  ...
  var genericFunc = new Data_Generic.Generic(function (v) {
      ...
      throw new Error("Failed pattern match at Insect.Language line 26, column 1 - line 26, column 43: " + [ v.constructor.name ]);
  });
  ...
  var genericBinOp = new Data_Generic.Generic(function (v) {
      ...
      throw new Error("Failed pattern match at Insect.Language line 44, column 1 - line 44, column 45: " + [ v.constructor.name ]);
  });
  ...
  var showExpression = new Data_Show.Show(function (v) {
      ...
      if (v instanceof Func) {
          return "(Func " + (Data_Show.show(showBinOp)(v.value0) + (" [" + (Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(", ")(Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(showExpression))(v.value1)) + ("]" + ")"))));
      };
      throw new Error("Failed pattern match at Insect.Language line 59, column 3 - line 60, column 3: " + [ v.constructor.name ]);
  });
  exports["Add"] = Add;
  exports["Sub"] = Sub;
  exports["Mul"] = Mul;
...
(function(exports) {
  ...
  var hexNumber = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Array.filter(function (v) {
      return v !== "'";
      ...
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Applicative.when(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Data_Array.length(v) > 8)(Text_Parsing_Parser.fail(Data_Identity.monadIdentity)("Hexadecimal numbers are limited to 32 bits which means 8 hexadecimal digits long. '\\x" + (Data_String.fromCharArray(v) + ("' is " + (Data_Show.show(Data_Show.showInt)(Data_Array.length(v)) + " digits long."))))))(function () {
          var $26 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(function ($46) {
              return Data_Int.fromStringAs(Data_Int.hexadecimal)(Data_String.fromCharArray(Data_Array.singleton($46)));
          })(v);
          ...
          if ($26 instanceof Data_Maybe.Just) {
              ...
              })(Data_Array.reverse($26.value0))))));
          };
          throw new Error("Failed pattern match at Insect.Parser line 124, column 3 - line 133, column 21: " + [ $26.constructor.name ]);
      });
  });
  ...
  var binNumber = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Array.filter(function (v) {
      return v !== "'";
  }))(Data_Array.some(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(binDigit))("a binary digit"))))(function (v) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Functor["void"](Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(hexDigit))(function ($47) {
          return Text_Parsing_Parser.fail(Data_Identity.monadIdentity)((function (c) {
              return "Unexpected digit " + (Data_Show.show(Data_Show.showChar)(c) + ".\x0aBinary numbers can only contain 0s or 1s.\x0a\x0aError found");
          })($47));
      }))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Data_Unit.unit))))(function () {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Applicative.when(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Data_Array.length(v) > 32)(Text_Parsing_Parser.fail(Data_Identity.monadIdentity)("Binary numbers are limited to 32 bits which means 32 binary digits long. '\\b" + (Data_String.fromCharArray(v) + ("' is " + (Data_Show.show(Data_Show.showInt)(Data_Array.length(v)) + " digits long."))))))(function () {
              var $37 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(function ($48) {
                  return Data_Int.fromStringAs(Data_Int.hexadecimal)(Data_String.fromCharArray(Data_Array.singleton($48)));
              })(v);
              ...
              if ($37 instanceof Data_Maybe.Just) {
                  ...
                  })(Data_Array.reverse($37.value0))))));
              };
              throw new Error("Failed pattern match at Insect.Parser line 96, column 3 - line 105, column 21: " + [ $37.constructor.name ]);
          });
      });
  });
  var basedNumber = (function () {
      var parserList = new Data_List_Types.Cons({
          "char": "x", 
          desc: "hex", 
          parser: hexNumber
      ...
      var myOneOf = function (list) {
          return function (v) {
              if (v instanceof Data_List_Types.Cons) {
                  return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(v["value0"]["char"]))(v.value0.parser))(myOneOf(list)(v.value1));
              };
              if (v instanceof Data_List_Types.Nil) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.anyChar(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity))(function (v1) {
                      return Text_Parsing_Parser.fail(Data_Identity.monadIdentity)("Unexpected character " + (Data_Show.show(Data_Show.showChar)(v1) + (".\x0aExpecting one of the following:\x0a\x0a" + (Data_Foldable.foldMap(Data_List_Types.foldableList)(Data_Monoid.monoidString)(function (p) {
                          return "  * " + (Data_Show.show(Data_Show.showChar)(p["char"]) + (" for " + (p.desc + "\x0a")));
                      })(list) + "\x0aError found"))));
                  });
              };
              throw new Error("Failed pattern match at Insect.Parser line 223, column 20 - line 236, column 1: " + [ v.constructor.name ]);
          };
      };
      return myOneOf(parserList)(parserList);
  })();
  ...
  var expression = (function () {
      ...
      return Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (p) {
          var atomic = Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (a) {
              return Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(whiteSpace)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(parens(p))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Insect_Language.Scalar.create)(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\\"))(basedNumber))))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Insect_Language.Scalar.create)(number)))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Insect_Language.Unit.create)(rep)))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Insect_Language.Func.create)(binOpName))(Data_Array.some(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(a))))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Insect_Language.BinOp.create)(binOpName))(a))(a)))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Insect_Language.Apply.create)(funcName))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(whiteSpace)(a))))(variable))(Text_Parsing_Parser.fail(Data_Identity.monadIdentity)("Expecting an expression"))))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(whiteSpace)(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)));
          });
...
(function(exports) {
  ...
  var prettyPrint = function (v) {
      ...
      if (v.rep instanceof Insect_Language.Binary) {
          return "\\b" + (function () {
              ...
              if (!$30) {
                  var $31 = v.value === Insect_Environment.minInt;
                  if ($31) {
                  ...
                  throw new Error("Failed pattern match at Insect.Interpreter line 206, column 11 - line 210, column 75: " + [ $31.constructor.name ]);
              };
              throw new Error("Failed pattern match at Insect.Interpreter line 201, column 7 - line 210, column 75: " + [ $30.constructor.name ]);
          })();
      };
      if (v.rep instanceof Insect_Language.Hex) {
          return "\\x" + (function () {
              ...
              if (!$32) {
                  ...
                  var $33 = Data_String.length(str) < 8;
                  if ($33) {
                  ...
                  throw new Error("Failed pattern match at Insect.Interpreter line 220, column 13 - line 222, column 132: " + [ $33.constructor.name ]);
              };
              throw new Error("Failed pattern match at Insect.Interpreter line 213, column 7 - line 222, column 132: " + [ $32.constructor.name ]);
          })();
      };
      throw new Error("Failed pattern match at Insect.Interpreter line 197, column 3 - line 222, column 132: " + [ v.rep.constructor.name ]);
  };
  ...
  var evalErrorMessage = function (v) {
      ...
      throw new Error("Failed pattern match at Insect.Interpreter line 174, column 1 - line 174, column 41: " + [ v.constructor.name ]);
  };
  ...
  var message = function (v) {
      return function (env) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Insect.Interpreter line 182, column 1 - line 185, column 4: " + [ v.constructor.name, env.constructor.name, v1.constructor.name ]);
          };
      };
  };
                  ...
                  if (v instanceof Insect_Language.Sar) {
                      return overValue(function (x) {
                          return function (y) {
                              ...
                              throw new Error("Failed pattern match at Insect.Interpreter line 51, column 9 - line 53, column 38: " + [ $67.constructor.name ]);
                          };
                      });
                  };
                  if (v instanceof Insect_Language.Sal) {
                      return overValue(function (x) {
                          return function (y) {
                              ...
                              throw new Error("Failed pattern match at Insect.Interpreter line 56, column 9 - line 58, column 38: " + [ $68.constructor.name ]);
                          };
                      });
                  };
  ...
  var $$eval = function (env) {
      return function (v) {
          ...
          if (v instanceof Insect_Language.Variable) {
              var $73 = Data_StrMap.lookup(v.value0)(env);
              if ($73 instanceof Data_Maybe.Just) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(new Insect_Language.Scalar($73.value0));
              };
              if ($73 instanceof Data_Maybe.Nothing) {
                  return new Data_Either.Left(new LookupError(v.value0));
              };
              throw new Error("Failed pattern match at Insect.Interpreter line 119, column 3 - line 121, column 39: " + [ $73.constructor.name ]);
          };
          ...
          if (v instanceof Insect_Language.BinOp) {
              return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v.value1))(function (v1) {
                  return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v.value2))(function (v2) {
                      ...
                      if ($82.op instanceof Insect_Language.ConvertTo && ($82.arg1 instanceof Insect_Language.Scalar && $82.arg2 instanceof Insect_Language.Unit)) {
                      ...
                      if ($82.arg1 instanceof Insect_Language.Scalar && $82.arg2 instanceof Insect_Language.Scalar) {
                          return Control_Applicative.pure(Data_Either.applicativeEither)(Insect_Language.Scalar.create(applyBinOp(v.value0)($82.arg1.value0)($82.arg2.value0)));
                      };
                      return Data_Either.Left.create(EvaluationError.create("Could not apply a function to expressions which are not reduced to scalars.\x0aThe evaluation of the expressions is: " + (Data_Show.show(Insect_Language.showExpression)($82.arg1) + (" and " + Data_Show.show(Insect_Language.showExpression)($82.arg2)))));
                  });
              });
          };
          if (v instanceof Insect_Language.Func) {
              var go = function (v1) {
                  if (v1 instanceof Data_List_Types.Nil) {
                      return Data_Either.Left.create(EvaluationError.create("Unexpected Arity. " + (Data_String.toLower(Data_Show.show(Insect_Language.showBinOp)(v.value0)) + " expects at least 1 argument.")));
                  };
                  if (v1 instanceof Data_List_Types.Cons && v1.value1 instanceof Data_List_Types.Nil) {
                      return $$eval(env)(v1.value0);
                  };
                  if (v1 instanceof Data_List_Types.Cons && v1.value1 instanceof Data_List_Types.Cons) {
                      return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v1.value0))(function (v2) {
                          return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v1.value1.value0))(function (v3) {
                              var $100 = {
                                  op: v.value0, 
                                  arg1: v2, 
                                  arg2: v3
                              };
                              if ($100.op instanceof Insect_Language.ConvertTo && ($100.arg1 instanceof Insect_Language.Scalar && $100.arg2 instanceof Insect_Language.Unit)) {
                                  return go(new Data_List_Types.Cons(new Insect_Language.Scalar(applyBinOp(Insect_Language.Add.value)({
                                      value: 0, 
                                      rep: $100.arg2.value0
                                  })($100.arg1.value0)), v1.value1.value1));
                              };
                              if ($100.arg1 instanceof Insect_Language.Scalar && $100.arg2 instanceof Insect_Language.Scalar) {
                                  return go(new Data_List_Types.Cons(new Insect_Language.Scalar(applyBinOp(v.value0)($100.arg1.value0)($100.arg2.value0)), v1.value1.value1));
                              };
                              return Data_Either.Left.create(EvaluationError.create("Could not apply a function to expressions which are not reduced to scalars.\x0aThe evaluation of the expressions is: " + (Data_Show.show(Insect_Language.showExpression)($100.arg1) + (" and " + Data_Show.show(Insect_Language.showExpression)($100.arg2)))));
                          });
                      });
                  };
                  throw new Error("Failed pattern match at Insect.Interpreter line 147, column 10 - line 169, column 33: " + [ v1.constructor.name ]);
              };
              return go(Data_List.fromFoldable(Data_Foldable.foldableArray)(v.value1));
          };
  ...
  var runInsect = function (env) {
      return function (v) {
          ...
          if (v instanceof Insect_Language.Assignment) {
              var $119 = $$eval(env)(v.value1);
              if ($119 instanceof Data_Either.Left) {
                  return message($$Error.value)(env)(new Data_Either.Left($119.value0));
              };
              if ($119 instanceof Data_Either.Right && $119.value0 instanceof Insect_Language.Scalar) {
                  return message(ValSet.value)(Data_StrMap.insert(v.value0)($119.value0.value0)(env))(new Data_Either.Right(new Insect_Language.Scalar($119.value0.value0)));
              };
              if ($119 instanceof Data_Either.Right) {
                  return message(Other.value)(env)(new Data_Either.Right($119.value0));
              };
              throw new Error("Failed pattern match at Insect.Interpreter line 229, column 3 - line 232, column 51: " + [ $119.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Insect.Interpreter line 227, column 1 - line 227, column 60: " + [ env.constructor.name, v.constructor.name ]);
      };
  };
