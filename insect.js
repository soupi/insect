...
(function(exports) {
  ...
  var prettyPrint = function (v) {
      if (v.rep instanceof Insect_Language.Binary) {
          return "\\b" + Data_Int.toStringAs(Data_Int.binary)(v.value);
      };
      if (v.rep instanceof Insect_Language.Hex) {
          return "\\x" + Data_Int.toStringAs(Data_Int.hexadecimal)(v.value);
      };
      if (v.rep instanceof Insect_Language.Decimal) {
          return Data_Int.toStringAs(Data_Int.decimal)(v.value);
      };
      throw new Error("Failed pattern match at Insect.Interpreter line 119, column 3 - line 122, column 40: " + [ v.rep.constructor.name ]);
  };
  ...
  var evalErrorMessage = function (v) {
      ...
      throw new Error("Failed pattern match at Insect.Interpreter line 96, column 1 - line 96, column 41: " + [ v.constructor.name ]);
  };
  ...
  var message = function (v) {
      return function (env) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Insect.Interpreter line 104, column 1 - line 107, column 4: " + [ v.constructor.name, env.constructor.name, v1.constructor.name ]);
          };
      };
  };
      ...
      return function (v1) {
          return function (v2) {
              var run = function (v) {
                  ...
                  throw new Error("Failed pattern match at Insect.Interpreter line 39, column 11 - line 52, column 40: " + [ v.constructor.name ]);
              };
              return run(fn)(v1)(v2);
          };
      };
  ...
  var $$eval = function (env) {
      return function (v) {
          ...
          if (v instanceof Insect_Language.Variable) {
              var $46 = Data_StrMap.lookup(v.value0)(env);
              if ($46 instanceof Data_Maybe.Just) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(new Insect_Language.Scalar($46.value0));
              };
              if ($46 instanceof Data_Maybe.Nothing) {
                  return new Data_Either.Left(new LookupError(v.value0));
              };
              throw new Error("Failed pattern match at Insect.Interpreter line 69, column 3 - line 71, column 39: " + [ $46.constructor.name ]);
          };
          ...
          if (v instanceof Insect_Language.BinOp) {
              ...
              return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v.value1))(function (v1) {
                  return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v.value2))(function (v2) {
                      ...
                      if ($55.op instanceof Insect_Language.ConvertTo && ($55.arg1 instanceof Insect_Language.Scalar && $55.arg2 instanceof Insect_Language.Unit)) {
                      ...
                      if ($55.arg1 instanceof Insect_Language.Scalar && $55.arg2 instanceof Insect_Language.Scalar) {
                          return Control_Applicative.pure(Data_Either.applicativeEither)(Insect_Language.Scalar.create(applyBinOp(v.value0)($55.arg1.value0)($55.arg2.value0)));
                      };
                      return Data_Either.Left.create(EvaluationError.create("Could not apply a function to expressions which are not reduced to scalars.\x0aThe evaluation of the expressions is: " + (Data_Show.show(Insect_Language.showExpression)($55.arg1) + (" and " + Data_Show.show(Insect_Language.showExpression)($55.arg2)))));
                  });
              });
          };
          throw new Error("Failed pattern match at Insect.Interpreter line 66, column 1 - line 66, column 43: " + [ env.constructor.name, v.constructor.name ]);
      };
  };
  ...
  var runInsect = function (env) {
      return function (v) {
          ...
          if (v instanceof Insect_Language.Assignment) {
              var $71 = $$eval(env)(v.value1);
              if ($71 instanceof Data_Either.Left) {
                  return message($$Error.value)(env)(new Data_Either.Left($71.value0));
              };
              if ($71 instanceof Data_Either.Right && $71.value0 instanceof Insect_Language.Scalar) {
                  return message(ValSet.value)(Data_StrMap.insert(v.value0)($71.value0.value0)(env))(new Data_Either.Right(new Insect_Language.Scalar($71.value0.value0)));
              };
              if ($71 instanceof Data_Either.Right) {
                  return message(Other.value)(env)(new Data_Either.Right($71.value0));
              };
              throw new Error("Failed pattern match at Insect.Interpreter line 129, column 3 - line 132, column 51: " + [ $71.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Insect.Interpreter line 127, column 1 - line 127, column 82: " + [ env.constructor.name, v.constructor.name ]);
      };
  };
