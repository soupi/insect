...
(function(exports) {
  ...
  var genericRep = new Data_Generic.Generic(function (v) {
      ...
      throw new Error("Failed pattern match at Insect.Language line 72, column 1 - line 72, column 41: " + [ v.constructor.name ]);
  });
  ...
  var genericBinOp = new Data_Generic.Generic(function (v) {
      ...
      throw new Error("Failed pattern match at Insect.Language line 42, column 1 - line 42, column 45: " + [ v.constructor.name ]);
  });
  ...
  var showExpression = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Insect.Language line 56, column 3 - line 57, column 3: " + [ v.constructor.name ]);
  });
  exports["Add"] = Add;
  exports["Sub"] = Sub;
  exports["Mul"] = Mul;
...
(function(exports) {
  ...
  var funcName = Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("complement"))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Insect_Language.Complement.value));
  ...
  var expression = (function () {
      ...
      return Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (p) {
          var atomic = Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(whiteSpace)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(parens(p))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Insect_Language.Scalar.create)(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\\"))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(hexNumber)(binNumber)))))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Insect_Language.Scalar.create)(number)))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Insect_Language.Unit.create)(rep))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Insect_Language.BinOp.create)(binOpName))(p))(p))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Insect_Language.Apply.create)(funcName))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(whiteSpace)(p)))))(variable)))(whiteSpace);
...
(function(exports) {
  ...
  var prettyPrint = function (v) {
      ...
      if (v.rep instanceof Insect_Language.Binary) {
          return "\\b" + (function () {
              ...
              if (!$18) {
                  var $19 = v.value === Insect_Environment.minInt;
                  if ($19) {
                  ...
                  throw new Error("Failed pattern match at Insect.Interpreter line 132, column 11 - line 136, column 75: " + [ $19.constructor.name ]);
              };
              throw new Error("Failed pattern match at Insect.Interpreter line 127, column 7 - line 136, column 75: " + [ $18.constructor.name ]);
          })();
      };
          ...
          return "\\x" + (function () {
              ...
              if (!$20) {
                  ...
                  if (!$21) {
                      ...
                      throw new Error("Failed pattern match at Insect.Interpreter line 149, column 17 - line 151, column 136: " + [ $22.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Insect.Interpreter line 144, column 11 - line 151, column 136: " + [ $21.constructor.name ]);
              };
              throw new Error("Failed pattern match at Insect.Interpreter line 139, column 7 - line 151, column 136: " + [ $20.constructor.name ]);
          })();
      };
      throw new Error("Failed pattern match at Insect.Interpreter line 123, column 3 - line 151, column 136: " + [ v.rep.constructor.name ]);
  };
  ...
  var evalErrorMessage = function (v) {
      ...
      throw new Error("Failed pattern match at Insect.Interpreter line 100, column 1 - line 100, column 41: " + [ v.constructor.name ]);
  };
  ...
  var message = function (v) {
      return function (env) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Insect.Interpreter line 108, column 1 - line 111, column 4: " + [ v.constructor.name, env.constructor.name, v1.constructor.name ]);
          };
      };
  };
          ...
          return function (v2) {
              var run = function (v) {
                  ...
                  if (v instanceof Insect_Language.Shr) {
                      return overValue(Data_Int_Bits.shr);
                  };
                  if (v instanceof Insect_Language.Shl) {
                      return overValue(Data_Int_Bits.shl);
                  };
                  ...
                  throw new Error("Failed pattern match at Insect.Interpreter line 43, column 11 - line 56, column 40: " + [ v.constructor.name ]);
              };
              return run(fn)(v1)(v2);
          };
      };
  ...
  var $$eval = function (env) {
      return function (v) {
          ...
          if (v instanceof Insect_Language.Variable) {
              var $52 = Data_StrMap.lookup(v.value0)(env);
              if ($52 instanceof Data_Maybe.Just) {
                  return Control_Applicative.pure(Data_Either.applicativeEither)(new Insect_Language.Scalar($52.value0));
              };
              if ($52 instanceof Data_Maybe.Nothing) {
                  return new Data_Either.Left(new LookupError(v.value0));
              };
              throw new Error("Failed pattern match at Insect.Interpreter line 73, column 3 - line 75, column 39: " + [ $52.constructor.name ]);
          };
          ...
          if (v instanceof Insect_Language.BinOp) {
              ...
              return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v.value1))(function (v1) {
                  return Control_Bind.bind(Data_Either.bindEither)($$eval(env)(v.value2))(function (v2) {
                      ...
                      if ($61.op instanceof Insect_Language.ConvertTo && ($61.arg1 instanceof Insect_Language.Scalar && $61.arg2 instanceof Insect_Language.Unit)) {
                      ...
                      if ($61.arg1 instanceof Insect_Language.Scalar && $61.arg2 instanceof Insect_Language.Scalar) {
                          return Control_Applicative.pure(Data_Either.applicativeEither)(Insect_Language.Scalar.create(applyBinOp(v.value0)($61.arg1.value0)($61.arg2.value0)));
                      };
                      return Data_Either.Left.create(EvaluationError.create("Could not apply a function to expressions which are not reduced to scalars.\x0aThe evaluation of the expressions is: " + (Data_Show.show(Insect_Language.showExpression)($61.arg1) + (" and " + Data_Show.show(Insect_Language.showExpression)($61.arg2)))));
                  });
              });
          };
          throw new Error("Failed pattern match at Insect.Interpreter line 70, column 1 - line 70, column 43: " + [ env.constructor.name, v.constructor.name ]);
      };
  };
  ...
  var runInsect = function (env) {
      return function (v) {
          if (v instanceof Insect_Language.Expression) {
              return message(Val.value)(env)($$eval(env)(Debug_Trace.traceShow(Insect_Language.showExpression)(v.value0)(Data_Function["const"](v.value0))));
          };
          if (v instanceof Insect_Language.Assignment) {
              var $77 = $$eval(env)(v.value1);
              if ($77 instanceof Data_Either.Left) {
                  return message($$Error.value)(env)(new Data_Either.Left($77.value0));
              };
              if ($77 instanceof Data_Either.Right && $77.value0 instanceof Insect_Language.Scalar) {
                  return message(ValSet.value)(Data_StrMap.insert(v.value0)($77.value0.value0)(env))(new Data_Either.Right(new Insect_Language.Scalar($77.value0.value0)));
              };
              if ($77 instanceof Data_Either.Right) {
                  return message(Other.value)(env)(new Data_Either.Right($77.value0));
              };
              throw new Error("Failed pattern match at Insect.Interpreter line 158, column 3 - line 161, column 51: " + [ $77.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Insect.Interpreter line 156, column 1 - line 156, column 82: " + [ env.constructor.name, v.constructor.name ]);
      };
  };
